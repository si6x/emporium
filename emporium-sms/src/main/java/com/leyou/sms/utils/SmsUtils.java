...
public class SmsUtils {
    ...
    public SendSmsResponse sendSms(String phone, String code, String signName, String template) throws ClientException {
        ...
        IClientProfile profile = DefaultProfile.getProfile("cn-shenzhen", prop.getAccessKeyId(), prop.getAccessKeySecret());
        DefaultProfile.addEndpoint("cn-shenzhen", PRODUCT, DOMAIN);
